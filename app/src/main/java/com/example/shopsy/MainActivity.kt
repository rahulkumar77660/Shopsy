...
import com.example.shopsy.adapter.ProductAdapter
import com.example.shopsy.interfaces.OrderApiInterface
import com.example.shopsy.interfaces.ProductsInterface
import com.example.shopsy.model.BuyProductModel
import com.example.shopsy.model.Notes
import com.example.shopsy.model.OrderApiReq
import com.example.shopsy.model.OrderApiRes
import com.example.shopsy.model.ProductModel
...
//            Toast.makeText(this, "Google Sign-In code found", Toast.LENGTH_SHORT).show()
...
//                    Toast.makeText(this, "failed", Toast.LENGTH_SHORT).show()
    ...
    override fun buyProduct(pAmount: Int, pId: String) {
        ...
        val header = "Basic cnpwX3Rlc3RfOUpaaVdBUnVrQVVtUVI6MjVzUHJBM1BwYmI0R242blFPOU9BajFz"
